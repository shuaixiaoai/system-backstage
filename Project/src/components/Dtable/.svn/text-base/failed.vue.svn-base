    ...
    <div class="">
      ...
      <el-table-column
        ...
        <el-table-column
            ...
            >
            <template scope="scope">
                <span v-if="scope.row.refund_status==0">无退款</span>
                <span v-if="scope.row.refund_status==1">全部退款</span>
                <span v-if="scope.row.refund_status==2">部分退款</span>
            </template>
        </el-table-column>
        <el-table-column
            prop="cancel_text"
...
<script>
  ...
  export default {
    ...
    mounted () {
      let that = this
      this.loading = true
      var url = '/order/order/orderlist?shopId=10002&page=1&orderStatus=0'
    ...
    methods: {
      ...
      handleCurrentChange (page) {
        var that = this
        var url = '/order/order/orderlist?shopId=10002&page=' + page + '&orderStatus=0'
