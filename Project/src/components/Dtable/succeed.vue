<template>
    <div class="succeed">
      <div class="operate-wrapper">
          ...
          <!-- <el-button @click="printOrder()" type="info">打印订单</el-button> -->
      </div>
      <el-table
      ref="multipleTable"
      :data="tableData"
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.loading = true
      var url = '/order/order/orderlist?shopId=10002&page=1&orderStatus=50,60'
    ...
    methods: {
      ...
      handleCurrentChange (page) {
        var that = this
        var url = '/order/order/orderlist?shopId=10002&page=' + page + '&orderStatus=50,60'
